...
int main() {
    ...
    // Add macroscopic mesh objects
    // MeshObject(id, center_of_mass, velocity, mass, radius)
    sim.addMeshObject(MeshObject(1, Vec3(-5, 5, 0), Vec3(2, 0, 0), 1000.0, 2.0));
    sim.addMeshObject(MeshObject(2, Vec3(5, 5, 0), Vec3(-2, 0, 0), 1000.0, 2.0));
